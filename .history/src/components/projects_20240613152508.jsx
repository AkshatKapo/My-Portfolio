            ...
            <div class="project-list">
              ...
              <div class="project-row">
                <div class="project">
                  ...
                  <a href="/assets/images/Machine Learning Final Project (2).pdf" target="_blank" className="Projectbutton" rel="noopener noreferrer">View Report</a>
                ...
                <div class="project">
                  ...
                  <a href="/assets/images/100781511AkshatKapoorTestDesignAssignmentNextDate.pdf" target="_blank" className="Projectbutton" rel="noopener noreferrer">View Report</a>
                  <a href="link-to-project1" class="Projectbutton2">View Project</a>
                </div>
              </div>
              <div class="project-row">
