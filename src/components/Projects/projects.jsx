      ...
      <div class="project-list">
        ...
        <div class="project-row">
          <div class="project">
            ...
            <p>I developed a PyTorch-based neural network with a four-layer feedforward architecture to classify MNIST handwritten digits. Key tasks included data preparation, model optimization, and thorough documentation.</p>
          ...
          <div class="project">
            ...
            <p>Developed a Java program for next-day date calculation, leveraging JUnit for systematic testing. </p>
            <a href="link-to-project1" class="Projectbutton">View Report</a>
            <a href="link-to-project1" class="Projectbutton2">View Project</a>
          </div>
        </div>
